...
if("TRUE" STREQUAL "TRUE")
  set(moveit_tutorials_SOURCE_PREFIX /home/criag/andreas_arm/src/moveit_tutorials)
  set(moveit_tutorials_DEVEL_PREFIX /home/criag/andreas_arm/devel)
  ...
  set(moveit_tutorials_INSTALL_PREFIX /home/criag/andreas_arm/install)
...
if(NOT "/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/criag/andreas_arm/src/moveit_tutorials/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
